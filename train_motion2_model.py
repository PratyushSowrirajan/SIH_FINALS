"""
Train a 'motion2' gesture classifier
...
print("=" * 70)
print(" 'MOTION2' GESTURE CLASSIFIER TRAINER")
print("=" * 70)

# Load dataset
print("\n📂 Loading dataset...")
data = pd.read_csv('motion2_dataset_20251211_122804.csv')

print(f"✅ Dataset loaded: {len(data)} samples, {data['trial_id'].max()} trials")
print(f"   Gesture: {data['sign_name'].iloc[0]}")
...
print("\n🧠 Creating 'motion2' gesture template...")
trials = []
...
with open('motion2_gesture_model.pkl', 'wb') as f:
    pickle.dump(model, f)

print("\n💾 Model saved: motion2_gesture_model.pkl")
print("\n" + "=" * 70)
print(" TRAINING COMPLETE!")
print("=" * 70)
print(f"✅ 'motion2' gesture model ready for real-time detection")
print(f"📊 Accuracy: {accuracy:.1f}%")
print(f"🎯 Use 'test_motion2_realtime.py' to test live gestures!")
print("=" * 70)
