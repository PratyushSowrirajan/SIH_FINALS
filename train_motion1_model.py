"""
Train a 'motion1' gesture classifier
...
print("=" * 70)
print(" 'MOTION1' GESTURE CLASSIFIER TRAINER")
print("=" * 70)

# Load dataset
print("\n📂 Loading dataset...")
data = pd.read_csv('motion1_dataset_20251211_113747.csv')
...
print("\n🧠 Creating 'motion1' gesture template...")
trials = []
...
with open('motion1_gesture_model.pkl', 'wb') as f:
    pickle.dump(model, f)

print("\n💾 Model saved: motion1_gesture_model.pkl")
print("\n" + "=" * 70)
print(" TRAINING COMPLETE!")
print("=" * 70)
print(f"✅ 'motion1' gesture model ready for real-time detection")
print(f"📊 Accuracy: {accuracy:.1f}%")
print(f"🎯 Use 'test_motion1_realtime.py' to test live gestures!")
print("=" * 70)
