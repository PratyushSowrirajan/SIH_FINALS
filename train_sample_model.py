"""
Train a 'sample' sign classifier (open palm -> closed fist)
...
print("=" * 70)
print(" 'SAMPLE' SIGN CLASSIFIER TRAINER")
print("=" * 70)

# Load dataset
print("\n📂 Loading dataset...")
data = pd.read_csv('sample_dataset_20251210_111532.csv')
...
with open('sample_sign_model.pkl', 'wb') as f:
    pickle.dump(model, f)

print("\n💾 Model saved: sample_sign_model.pkl")
print("\n" + "=" * 70)
print(" TRAINING COMPLETE!")
print("=" * 70)
print(f"✅ 'sample' sign model ready for real-time detection")
print(f"📊 Accuracy: {accuracy:.1f}%")
print(f"🎯 Use 'test_sample_realtime.py' to test live gestures!")
print("=" * 70)
