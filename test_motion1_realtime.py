"""
Real-time 'motion1' gesture detector
...
print("=" * 70)
print(" REAL-TIME 'MOTION1' GESTURE DETECTOR")
print("=" * 70)

# Load trained model
print("\n📂 Loading trained model...")
try:
    with open('motion1_gesture_model.pkl', 'rb') as f:
        model = pickle.load(f)
    ...
    print("❌ Model not found! Run 'train_motion1_model.py' first.")
    exit(1)
...
def record_and_classify():
    ...
    time.sleep(1)
    print("🔴 RECORDING... Do the MOTION1 gesture NOW!")
    ...
    if is_motion1:
        print(f"\n   ✅ DETECTED: '{sign_name}' gesture! 🎉")
    else:
        print(f"\n   ❌ NOT '{sign_name}' gesture")
